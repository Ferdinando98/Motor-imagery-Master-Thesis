...
#include "motor_imagery/GrabAction.h"
#include "motor_imagery/MoveAction.h"
#include "motor_imagery/ReleaseAction.h"
#include "motor_imagery/GrabAndReleaseAction.h"
...
class Interface
{
    private:
        ...
        actionlib::SimpleActionClient<motor_imagery::GrabAction> grabClient_;
        actionlib::SimpleActionClient<motor_imagery::MoveAction> moveClient_;
        actionlib::SimpleActionClient<motor_imagery::ReleaseAction> releaseClient_;
        actionlib::SimpleActionClient<motor_imagery::GrabAndReleaseAction> grabAndReleaseClient_;

        motor_imagery::MoveGoal MOVE_GOAL_;
        motor_imagery::GrabGoal GRAB_GOAL_;
        motor_imagery::ReleaseGoal RELEASE_GOAL_;
        motor_imagery::GrabAndReleaseGoal GRAB_AND_REL_GOAL_;
