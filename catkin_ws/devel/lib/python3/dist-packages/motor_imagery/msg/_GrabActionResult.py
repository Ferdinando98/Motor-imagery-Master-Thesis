...
"""autogenerated by genpy from motor_imagery/GrabActionResult.msg. Do not edit."""
import codecs
import sys
...
class GrabActionResult(genpy.Message):
  ...
  _type = "motor_imagery/GrabActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','motor_imagery/GrabResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = motor_imagery.msg.GrabResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = motor_imagery.msg.GrabResult()
