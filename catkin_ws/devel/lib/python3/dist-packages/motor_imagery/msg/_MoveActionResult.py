...
"""autogenerated by genpy from motor_imagery/MoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveActionResult(genpy.Message):
  ...
  _type = "motor_imagery/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','motor_imagery/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = motor_imagery.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = motor_imagery.msg.MoveResult()
