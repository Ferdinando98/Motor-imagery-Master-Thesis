...
"""autogenerated by genpy from motor_imagery/MoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveActionFeedback(genpy.Message):
  ...
  _type = "motor_imagery/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','motor_imagery/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = motor_imagery.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = motor_imagery.msg.MoveFeedback()
