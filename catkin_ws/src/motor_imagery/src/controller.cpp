...
#include "motor_imagery/sendInitState.h"
...
class Controller
{
    private:
        ...
        ros::Subscriber fingerSubscriber_;
        ...
        void fingerCallback(const kinova_msgs::FingerPositionConstPtr& fingerPosMsg)
        {
            FINGER_POS_ = {
                fingerPosMsg->finger1,
                fingerPosMsg->finger2,
                fingerPosMsg->finger3
            };
        }
        ...
        bool sendInitPose(motor_imagery::sendInitPose::Request& req, motor_imagery::sendInitPose::Response& res)
        {
            Eigen::Matrix4d T = directKinematics(JOINT_STATE_,JOINT_STATE_.size());
    ...
    public:
        ...
        Controller()
        {
            ...
            fingerSubscriber_ = nh_.subscribe("/j2s7s300_driver/out/finger_position", 1, &Controller::fingerCallback, this);
