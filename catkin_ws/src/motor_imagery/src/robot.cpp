...
class Robot
{
    ...
    public:
        ...
        Robot() : 
            fingerServer_(nh_, "/j2s7s300_driver/fingers_action/finger_position", boost::bind(&Robot::executeFingerCallback, this, _1), false)
        {
            ...
            fingerPublisher_ = nh_.advertise<kinova_msgs::FingerPosition>("/j2s7s300_driver/out/finger_position",1);
